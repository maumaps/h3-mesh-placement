...
def render_html_document(
    ...
    html_parts = [
        ...
        ".basemap-control{display:flex;overflow:hidden;}",
        ".basemap-control button{border:0;border-left:1px solid #d7dee4;background:#fff;color:#17324d;font:700 11px/1 'Trebuchet MS','Segoe UI',sans-serif;padding:8px 9px;cursor:pointer;}",
