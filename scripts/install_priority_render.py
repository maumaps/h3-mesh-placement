...
def render_html_document(
    ...
    html_parts = [
        ...
        ".basemap-control button{width:auto;min-width:42px;height:30px;border:0;border-left:1px solid #d7dee4;background:#fff;color:#17324d;font:700 11px/1 'Trebuchet MS','Segoe UI',sans-serif;padding:8px 9px;cursor:pointer;white-space:nowrap;}",
